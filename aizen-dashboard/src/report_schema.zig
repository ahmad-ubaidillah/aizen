...
const repo_specs = [_]RepoSpec{
    .{
        .id = .aizen-dashboard,
        .value = "aizen-dashboard",
        .display_name = "AizenDashboard",
        .github_repo = "aizen/aizen-dashboard",
        .local_checkout_path = "../aizen-dashboard",
    },
    .{
        .id = .aizen,
        .value = "aizen",
        .display_name = "Aizen",
        .github_repo = "aizen/aizen",
        .local_checkout_path = "../aizen",
    },
    .{
        .id = .aizen-orchestrate,
        .value = "aizen-orchestrate",
        .display_name = "AizenOrchestrate",
        .github_repo = "aizen/AizenOrchestrate",
        .local_checkout_path = "../AizenOrchestrate",
    },
    .{
        .id = .aizen-kanban,
        .value = "aizen-kanban",
        .display_name = "AizenKanban",
        .github_repo = "aizen/aizen-kanban",
        .local_checkout_path = "../aizen-kanban",
    },
    .{
        .id = .aizen-watch,
        .value = "aizen-watch",
        .display_name = "AizenWatch",
        .github_repo = "aizen/aizen-watch",
        .local_checkout_path = "../aizen-watch",
    },
};
...
test "repo order is stable" {
    try std.testing.expectEqualStrings("aizen-dashboard", repos()[0].value);
    try std.testing.expectEqualStrings("aizen", repos()[1].value);
    try std.testing.expectEqualStrings("aizen-orchestrate", repos()[2].value);
    try std.testing.expectEqualStrings("aizen-kanban", repos()[3].value);
    try std.testing.expectEqualStrings("aizen-watch", repos()[4].value);
}

...
pub const public_alias_host = "aizen-dashboard.local";
pub const canonical_local_host = "aizen-dashboard.localhost";
...
test "buildAccessUrls uses aizen-dashboard local chain for loopback binds" {
    ...
    try std.testing.expectEqualStrings("http://aizen-dashboard.local:19800", urls.public_alias_url.?);
    try std.testing.expectEqualStrings("http://aizen-dashboard.localhost:19800", urls.browser_open_url);
    try std.testing.expectEqualStrings("http://aizen-dashboard.localhost:19800", urls.canonical_url);

...
const component_param = ParamSpec{
    ...
    .location = "path",
    .required = true,
    .description = "Component name such as aizen, aizen-dashboard, aizen-orchestrate, or aizen-kanban.",
};
...
const log_source_query = ParamSpec{
    ...
    .location = "query",
    .required = false,
    .description = "Log source selector: instance or aizen-dashboard.",
};
...
const history_session_query = ParamSpec{
    ...
    .location = "query",
    .required = false,
    .description = "Optional aizen session identifier to scope history.",
};
...
const memory_session_query = ParamSpec{
    ...
    .location = "query",
    .required = false,
    .description = "Optional aizen session identifier to scope memory reads or writes.",
};
...
const instance_channel_type_param = ParamSpec{
    ...
    .location = "path",
    .required = true,
    .description = "Canonical aizen channel type such as telegram, discord, or web.",
};
...
const route_examples_status = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api GET /api/status --pretty",
...
const route_examples_instances = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api GET /api/instances --pretty",
...
const route_examples_instance_status = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api GET /api/instances/aizen/instance-1/status --pretty",
        .description = "Read the managed aizen runtime status through the instance admin boundary.",
    },
};

const route_examples_delete_instance = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api DELETE /api/instances/aizen/instance-2",
        .description = "Delete a managed aizen instance and let aizen-dashboard clean related state.",
    },
};

const route_examples_provider_validate = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api POST /api/providers/2/validate",
...
const route_examples_skill_catalog = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api GET '/api/instances/aizen/instance-1/skills?catalog=1' --pretty",
        .description = "Inspect the recommended skill catalog for a managed aizen instance.",
    },
};

const route_examples_skill_install = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api POST /api/instances/aizen/instance-1/skills --body '{\"bundled\":\"aizen-dashboard-admin\"}'",
        .description = "Install the bundled aizen-dashboard-admin skill into a managed aizen workspace.",
    },
    .{
        .command = "aizen-dashboard api POST /api/instances/aizen/instance-1/skills --body '{\"clawhub_slug\":\"my-skill\"}'",
        .description = "Install a skill from ClawHub when the host has the clawhub CLI available.",
    },
    .{
        .command = "aizen-dashboard api POST /api/instances/aizen/instance-1/skills --body '{\"name\":\"news-digest\"}'",
        .description = "Search the skill registry and install the best matching skill through the managed aizen CLI.",
    },
};

const route_examples_skill_remove = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api DELETE '/api/instances/aizen/instance-1/skills?name=aizen-dashboard-admin'",
        .description = "Remove a workspace-installed skill from a managed aizen instance.",
    },
};

const route_examples_channels = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard api GET /api/instances/aizen/instance-1/channels --pretty",
        .description = "List configured channel accounts for a managed aizen instance.",
    },
    .{
        .command = "aizen-dashboard api GET /api/instances/aizen/instance-1/channels/telegram --pretty",
...
const route_examples_meta = [_]ExampleSpec{
    .{
        .command = "aizen-dashboard routes --json",
        .description = "Inspect the machine-readable route catalog locally without a running server.",
    },
    .{
        .command = "aizen-dashboard api GET /api/meta/routes --pretty",
...
const routes = [_]RouteSpec{
    ...
    .{
        ...
        .category = "meta",
        .summary = "Machine-readable catalog of stable aizen-dashboard HTTP routes.",
        .auth_mode = "optional_bearer",
    ...
    .{
        ...
        .category = "meta",
        .summary = "Alias for the machine-readable aizen-dashboard route catalog.",
        .auth_mode = "optional_bearer",
        .response = "JSON document with route ids, methods, paths, parameters, and examples.",
    },
    .{
    ...
    .{
        ...
        .auth_mode = "optional_bearer",
        .response = "Current aizen-dashboard settings document.",
    },
    .{
        .id = "settings.put",
        .method = "PUT",
    ...
    .{
        ...
        .category = "settings",
        .summary = "Install aizen-dashboard as an OS service.",
        .auth_mode = "optional_bearer",
    ...
    .{
        ...
        .category = "settings",
        .summary = "Remove the OS service installation for aizen-dashboard.",
        .auth_mode = "optional_bearer",
        .destructive = true,
    ...
    .{
        ...
        .category = "instances",
        .summary = "Read managed aizen runtime status using the instance admin CLI when available.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .response = "Aizen-style status payload with version, pid, uptime, overall_status, and components.",
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}",
        .category = "instances",
        .summary = "Delete an instance and let aizen-dashboard clean its managed files.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .destructive = true,
        .response = "Delete status payload.",
    ...
    .{
        ...
        .category = "instances",
        .summary = "List provider entries configured for a managed aizen instance without exposing secret values.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Inspect a single model/provider entry for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Read deep runtime health diagnostics for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Read the runtime capabilities manifest for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Invoke a stateful managed aizen agent turn.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Streaming agent turns are not supported through aizen-dashboard; this route returns 501.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .response = "Not implemented payload.",
    },
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/agent-sessions",
        .category = "instances",
        .summary = "Terminate a managed aizen agent session selected by session_id.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .query_params = session_query_params[0..],
        .destructive = true,
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/memory",
        .category = "instances",
        .summary = "Create, update, or delete a managed aizen memory entry.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .query_params = memory_query_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Trigger vector reindex for a managed aizen memory backend.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Drain the durable memory outbox queue for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "List configured channel accounts for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Inspect a specific configured aizen channel type.",
        .auth_mode = "optional_bearer",
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/skills",
        .category = "instances",
        .summary = "Install a skill into a managed aizen workspace from a bundled skill, ClawHub slug, registry search name, or source URL/path.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/skills",
        .category = "instances",
        .summary = "Remove a workspace-installed skill from a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .query_params = skills_query_params[0..],
        .body = null,
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/integration",
        .category = "instances",
        .summary = "Link or relink supported components such as aizen-orchestrate and aizen-kanban.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Import a standalone installation into aizen-dashboard management.",
        .auth_mode = "optional_bearer",
    ...
    .{
        ...
        .category = "instances",
        .summary = "Read the raw instance config.json managed by aizen-dashboard.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/config",
        .category = "instances",
        .summary = "Replace the raw instance config.json managed by aizen-dashboard.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Set a single dotted config value through the managed aizen CLI boundary.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Unset or reset a single dotted config value through the managed aizen CLI boundary.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Validate and re-read config.json from disk for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Validate current or proposed config JSON for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "List scheduled cron jobs for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/cron",
        .category = "instances",
        .summary = "Create a recurring shell or agent cron job for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Create a one-shot delayed shell or agent job for a managed aizen instance.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .category = "instances",
        .summary = "Read the log tail for an instance or its aizen-dashboard supervisor log.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
    ...
    .{
        ...
        .path_template = "/api/instances/{component}/{name}/logs",
        .category = "instances",
        .summary = "Clear stored log files for an instance or its aizen-dashboard supervisor log.",
        .auth_mode = "optional_bearer",
        .path_params = common_instance_params[0..],
        .query_params = logs_query_params[0..],
        .destructive = true,
    ...
    .{
        ...
        .summary = "Proxy orchestration requests to AizenOrchestrate, or store requests to AizenKanban.",
        .auth_mode = "optional_bearer",
...
pub fn textAlloc(allocator: std.mem.Allocator) ![]u8 {
    ...
    try buf.print("aizen-dashboard routes ({d})\n", .{routes.len});

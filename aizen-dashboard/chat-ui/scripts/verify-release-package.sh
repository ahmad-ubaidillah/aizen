...
TAR_PATH="${OUTDIR}/aizen-dashboard-ui-${VERSION}.tar.gz"
ZIP_PATH="${OUTDIR}/aizen-dashboard-ui-${VERSION}.zip"
...
required_entries=(
	"aizen-dashboard-ui/README.md"
	"aizen-dashboard-ui/package.json"
	"aizen-dashboard-ui/aizen-dashboard-ui"
	"aizen-dashboard-ui/aizen-dashboard-ui.cmd"
	"aizen-dashboard-ui/bin/aizen-dashboard-ui.js"
	"aizen-dashboard-ui/build/index.html"
)

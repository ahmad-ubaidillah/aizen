...
`aizen_ui_auth_v1` in local storage includes:
...
- `aizen-dashboard-ui-<tag>.tar.gz`
- `aizen-dashboard-ui-<tag>.zip`

Each archive contains:

- `aizen-dashboard-ui` (Unix launcher)
- `aizen-dashboard-ui.cmd` (Windows launcher)
- `bin/aizen-dashboard-ui.js`

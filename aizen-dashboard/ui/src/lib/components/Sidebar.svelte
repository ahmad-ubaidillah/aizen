<script lang="ts">
  ...
  let showOrchestration = $derived(Boolean(installedComponents["aizen-orchestrate"]?.installed));
...
<nav class="sidebar">
  <a href="/" class="logo" aria-label="Go to AizenDashboard home">
    <h2>AizenDashboard</h2>
  </a>

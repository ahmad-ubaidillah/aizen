<script lang="ts">
  ...
  onMount(() => {
    if (browser) {
      const savedTheme = localStorage.getItem("aizen-dashboard-theme");
      const savedEffects = localStorage.getItem("aizen-dashboard-effects");
  ...
  $effect(() => {
    if (browser && initialized) {
      localStorage.setItem("aizen-dashboard-theme", currentTheme);
      localStorage.setItem("aizen-dashboard-effects", effectsEnabled.toString());

...
const aizen-orchestrateSections: GenericSectionDef[] = [
  {
    key: "service",
    label: "Service",
    ...
    fields: [
      ...
      { key: "db", label: "Database Path", type: "text", default: "aizen-orchestrate.db" },
  ...
  },
  {
    key: "tracker",
    label: "Tracker",
    description: "Native AizenKanban pull-mode connection and lease management.",
    fields: [
      { key: "tracker.url", label: "Tracker URL", type: "text" },
      { key: "tracker.api_token", label: "Tracker API Token", type: "password" },
      { key: "tracker.agent_id", label: "Agent ID", type: "text", default: "aizen-orchestrate" },
  ...
  },
  {
    key: "subprocess",
    label: "Subprocess",
    description: "Default executor settings for spawned Aizen-compatible subprocesses.",
    fields: [
      { key: "tracker.subprocess.command", label: "Command", type: "text", default: "aizen" },
      {
...
const aizen-kanbanSections: GenericSectionDef[] = [
  {
    key: "service",
    label: "Service",
    ...
    fields: [
      ...
      { key: "db", label: "Database Path", type: "text", default: "aizen-kanban.db" },
      { key: "api_token", label: "API Token", type: "password" },
    ],
  },
];
...
export function getComponentConfigSchema(component: string): GenericSectionDef[] {
  switch (component) {
    case "aizen-orchestrate":
      return aizen-orchestrateSections;
    case "aizen-kanban":
      return aizen-kanbanSections;
    default:
      return [];
  }
}

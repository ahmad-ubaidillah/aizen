<script lang="ts">
  ...
  onMount(async () => {
    ...
    try {
      ...
      hasNullclaw = Object.keys(status.instances?.aizen || {}).length > 0;
    } catch {}
  });
...
<div class="channels-page">
  ...
  {#if !hasNullclaw && channels.length > 0}
    <div class="warning-message">
      Install a aizen instance to add new channels or re-validate saved ones.
    </div>
  {/if}
  ...
  {:else}
    {#if channels.length === 0}
      <div class="empty-state">
        ...
        {:else}
          <p>Install a aizen instance first to add and validate channels.</p>
          <a href="/install" class="link-btn">Install Aizen</a>
        {/if}
      </div>
    {:else}
            ...
            {:else}
              ...
              <div class="card-actions">
                <button
                  ...
                  title={hasNullclaw ? "Re-validate" : "Install aizen to re-validate"}
                >

  ...
  "resourceSpans": [
    {
      "resource": {
        "attributes": [
          { "key": "service.name", "value": { "stringValue": "aizen-kanban-e2e" } }
        ]
      },
      "scopeSpans": [
        {
          ...
          "spans": [
            {
              ...
              "attributes": [
                { "key": "aizen-kanban.run_id", "value": { "stringValue": "run-e2e" } },
                { "key": "aizen-kanban.task_id", "value": { "stringValue": "task-e2e" } }
              ],

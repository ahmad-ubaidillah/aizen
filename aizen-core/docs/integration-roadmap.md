# Integration Roadmap: aizen + aizen-orchestrate + aizen-kanban
...
| 4 | Self-Registration with aizen-orchestrate | 🟡 MEDIUM | Not started | 1 day |
| 5 | Workflow Tool (`create_workflow`) | 🟡 MEDIUM | Not started | 1-2 days |
| 6 | Topic-Aware Callback Routing | 🟡 MEDIUM | Not started | 1-2 days |
| 7 | aizen-kanban Push Notifications | 🟢 LOW | Not started | 2-3 days |

---

## Phase 1: Critical Path (Week 1)

**Goal:** Enable aizen-orchestrate → aizen communication
...
- [ ] **Gap 4:** Self-Registration
  - Config schema: `aizen-orchestrate.url`, `worker_id`, `tags`
...
- [ ] **Gap 7:** aizen-kanban Push Notifications
...
- `src/config.zig` — Add aizen-orchestrate config
...
2. Integration test: aizen-orchestrate dispatch → aizen worker → Telegram delivery
3. End-to-end: User message → orchestrator → workflow → coder → result in topic

### Dependencies

- aizen must be running with gateway enabled
- aizen-orchestrate must be accessible via HTTP
...
- aizen-orchestrate repo: `https://github.com/aizen/aizen-orchestrate`
- aizen-kanban repo: `https://github.com/aizen/aizen-kanban`

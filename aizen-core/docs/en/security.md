...
Aizen follows secure-by-default behavior: local bind by default, pairing auth, sandbox isolation, and least privilege.

## Page Guide

**Who this page is for**

- Operators hardening a local or tunneled Aizen deployment

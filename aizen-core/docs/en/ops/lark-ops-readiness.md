...
1. Run `aizen doctor` to confirm the channel config is structurally valid.
2. Run `aizen channel status` after startup to confirm whether the channel is running but disconnected.

...
This directory is the documentation index for aizen.
...
MB:## Core User Docs
TJ:
HP:- **Beginner's Guide:** New to Aizen? Start here. Plain language, no jargon. | [English](./en/beginners-guide.md) / [中文](./zh/beginners-guide.md)

/// Export manifest JSON for aizen-dashboard integration.
///
...
pub fn run() !void {
    ...
    try out.writeAll(
        ...
        \\    "x86_64-macos": { "asset": "aizen-macos-x86_64", "binary": "aizen" },
        \\    "x86_64-linux": { "asset": "aizen-linux-x86_64", "binary": "aizen" },
        \\    "aarch64-linux": { "asset": "aizen-linux-aarch64", "binary": "aizen" },
        \\    "riscv64-linux": { "asset": "aizen-linux-riscv64", "binary": "aizen" },
        \\    "x86_64-windows": { "asset": "aizen-windows-x86_64.exe", "binary": "aizen.exe" },
        \\    "aarch64-windows": { "asset": "aizen-windows-aarch64.exe", "binary": "aizen.exe" }
        \\  },
        \\
    );
    ...
    try out.writeAll(
        \\  "depends_on": [],
        \\  "connects_to": [
        \\    { "component": "aizen-orchestrate", "role": "worker", "description": "Registers as a worker node" }
        \\  ]
        \\}
        \\
    );

...
const USER_AGENT = "aizen-dingtalk/0.1.0";
const TOKEN_REFRESH_MARGIN_SECS: i64 = 300;
const RECONNECT_DELAY_NS: u64 = 5 * std.time.ns_per_s;
const ATTACHMENT_CACHE_SUBDIR = "aizen_dingtalk_media";
...
const BASIC_CARD_SCHEMA_TITLE = "aizen";
...
pub const DingTalkChannel = struct {
    ...
    fn buildRichWebhookBody(buf: []u8, payload: root.Channel.OutboundPayload) ![]const u8 {
        ...
        const title = if (payload.card_title.len > 0) payload.card_title else "Aizen";
